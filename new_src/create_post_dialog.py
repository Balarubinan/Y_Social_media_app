...
class Create_post_dialog(Frame):
    ...
    def setup_create_post(self):
        ...
        self.image_btn=Button(self.main_frame,text="Browse images",command=self.browse_image_path,font=self.font_size)
    ...
    def on_post(self):
        ...
        add_post(post_id,self.user_email,type,self.caption_bar.get(),0,self.image_paths[0])
